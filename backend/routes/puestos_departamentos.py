...
@puesto_departamento.get("/puestos_departamentos/", response_model=List[schemas.PuestoDepartamento])
...
@puesto_departamento.get("/puesto_departamento/{id}", response_model=schemas.PuestoDepartamento)
...
@puesto_departamento.post("/puestos_departamentos/", response_model=schemas.PuestoDepartamento)
...
@puesto_departamento.put("/puesto_departamento/{id}", response_model=schemas.PuestoDepartamento)
...
@puesto_departamento.delete("/puesto_departamento/{id}", response_model=schemas.PuestoDepartamento)
